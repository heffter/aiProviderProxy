...
const CASES: SyntheticCase[] = [
  ...
  anthropicUnary(
      ...
      messages: [
        {
          ...
          content: [
            {
              type: 'text',
              text: 'Summarize the rollout plan for the new service.',
            },
          ],
        },
      ],
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'Here is a concise summary of the rollout plan.',
        },
      ],
  ...
  anthropicUnary(
    'system-blocks',
    {
      ...
      messages: [
        {
          role: 'user',
          content: [{ type: 'text', text: 'Define idempotency.' }],
        },
      ],
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'An operation is idempotent when repeating it has no additional effect.',
        },
      ],
      stop_reason: 'end_turn',
  ...
  anthropicUnary(
    ...
    },
    {
      ...
      type: 'message',
      role: 'assistant',
      content: [{ type: 'text', text: 'It is sunny and 24C in Paris.' }],
      stop_reason: 'end_turn',
  ...
  anthropicUnary(
    'extended-thinking',
    {
      ...
      messages: [
        {
          role: 'user',
          content: [{ type: 'text', text: 'Prove sqrt(2) is irrational.' }],
        },
      ],
    },
    {
      ...
      role: 'assistant',
      content: [
        { type: 'thinking', thinking: 'Assume sqrt(2)=a/b in lowest terms...' },
        { type: 'text', text: 'By contradiction, sqrt(2) is irrational.' },
      ],
      stop_reason: 'end_turn',
  ...
  anthropicUnary(
    'prompt-caching-cache-control',
    {
      ...
      system: [
        {
          type: 'text',
          text: 'Large reusable context here.',
    ...
    },
    {
      ...
      type: 'message',
      role: 'assistant',
      content: [{ type: 'text', text: 'Continuing from cached context.' }],
      stop_reason: 'end_turn',
      usage: {
        input_tokens: 10,
        output_tokens: 8,
  ...
  anthropicUnary(
    'count-tokens',
    {
      ...
      messages: [
        {
          role: 'user',
          content: [{ type: 'text', text: 'How many tokens is this?' }],
        },
      ],
    },
    { input_tokens: 12 },
          ...
          choices: [
            {
              ...
              message: {
                role: 'assistant',
                content: 'REST is an architectural style for APIs.',
              },
              finish_reason: 'stop',
            },
          ],
...
if (require.main === module) {
  ...
  console.log(
    `Wrote ${written.length} synthetic cases to ${target}:\n  ${written.join('\n  ')}`,
  );
}
